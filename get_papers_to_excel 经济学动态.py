...
#《世界汉语教学》 http://d.wanfangdata.com.cn/periodical/sjhyjx201904005
...
def get_periodical_year_article(perioId, publishYear):
    ...
    URL = 'http://www.wanfangdata.com.cn/sns/third-web/per/perio/articleList'  ##？ 怎么找到的
    headers = {
...
def get_all_article_id(perioId='ywjs'):
    """
...
def get_wanfang_dataone_excel(req_id):
    ...
    try:
        ...
        # 拼接数据
            ...
            json_infos = {
                "文章中文标题": info['detail'][0]['periodical']['Title'][0],
                "英文标题":info['detail'][0]['periodical']['Title'][1],
                "摘要": info['detail'][0]['periodical']['Abstract'][0],
                "英文摘要": info['detail'][0]['periodical']['Abstract'][1],
    ...
    for i in range(start_num, end_num + 1):
        ...
        # 拼接数据
            ...
            json_infos = {
                ...
                "英文标题":info['detail'][0]['periodical']['Title'][1],
                "摘要": info['detail'][0]['periodical']['Abstract'][0],
                "英文摘要": info['detail'][0]['periodical']['Abstract'][0],
                "关键字": info['detail'][0]['periodical']['Keywords'],
                "作者": info['detail'][0]['periodical']['Creator'],
                "作者单位": info['detail'][0]['periodical']['AuthorOrg'],
                "期刊名称": info['detail'][0]['periodical']['PeriodicalTitle'],
